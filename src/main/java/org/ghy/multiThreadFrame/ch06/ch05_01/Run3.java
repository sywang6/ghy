...
public class Run3 {
    public static void main(String[] args) {
        try {
            ...
            System.out.println(System.currentTimeMillis()+" "+completionService.poll(2, TimeUnit.SECONDS).get());
            System.out.println("X");
            System.out.println(System.currentTimeMillis()+" "+completionService.poll(5, TimeUnit.SECONDS).get());
            System.out.println("X");
