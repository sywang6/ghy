...
public class C06E06_88th_Oscar_Combine_AddTOC {
    ...
    public static final String SRC1 = AabsolutePath.PROJECT_ROOR_PATH +"src/main/resources/pdf/88th_noms_announcement.pdf";
    public static final String SRC2 = AabsolutePath.PROJECT_ROOR_PATH +"src/main/resources/pdf/oscars_movies_checklist_2016.pdf";
    public static final String DEST =AabsolutePath.PROJECT_ROOR_PATH + "results/chapter06/88th_oscar_the_revenant_nominations_TOC.pdf";
