...
public class C07E03_UnitedStates_PDFA_3a {
    ...
    public static final String FONT = AabsolutePath.PROJECT_ROOR_PATH +"src/main/resources/font/FreeSans.ttf";
    public static final String BOLD_FONT =AabsolutePath.PROJECT_ROOR_PATH + "src/main/resources/font/FreeSansBold.ttf";
    public static final String INTENT = AabsolutePath.PROJECT_ROOR_PATH +"src/main/resources/color/sRGB_CS_profile.icm";

    public static final String DEST =AabsolutePath.PROJECT_ROOR_PATH + "results/chapter07/united_states_PDFA-3a.pdf";
