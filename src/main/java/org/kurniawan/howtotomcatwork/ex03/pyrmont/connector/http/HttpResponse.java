...
import org.kurniawan.howtotomcatwork.ex03.pyrmont.connector.ResponseStream;
import org.kurniawan.howtotomcatwork.ex03.pyrmont.connector.ResponseWriter;
...
import org.kurniawan.howtotomcatwork.ex03.pyrmont.util.CookieTools;
    ...
    try {
      ...
      */
      ...
      String headMessage = "HTTP/1.1 200 OK\r\n" +
              ...
              "\r\n";
      output.write(headMessage.getBytes());
